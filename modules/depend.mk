...
PUBLIC_LINKS += $(O_DIR)/_public/ft/assert.hpp $(O_DIR)/_public/ft/Color.hpp \
	...
	$(O_DIR)/_public/ft/Vec.hpp $(O_DIR)/_public/ft/templates/Rect.tpp \
	...
	$(O_DIR)/_public/ftlua/stackassert.hpp \
	...
	$(O_DIR)/_public/ftui/Button.hpp $(O_DIR)/_public/ftui/EventTarget.hpp \
	...
	$(O_DIR)/_public/ftui/TextView.hpp \
